            ...
            <div class="navbar-wrapper-2">
                <nav class="navbar bg-secondary">
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
                        ...
                        <span class="nav-menu">
                            <svg class="menu svg-toggle" xmlns="http://www.w3.org/2000/svg" width="20" height="20"><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
                            <svg class="x-icon svg-toggle" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
